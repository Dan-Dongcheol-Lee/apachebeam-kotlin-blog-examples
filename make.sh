...
runLocal() {
  ...
  ${workspace}/gradlew runJob -PjobClass="${jobClass}" -Poptions="
    ...
    --runner=DirectRunner
    --jobName=${jobName}
    --tempLocation=gs://${projectId}.appspot.com/dataflow-test/temp
    ${args}
    "
}
...
runCloud() {
  ...
  ${workspace}/gradlew runJob -PjobClass="${jobClass}" -Poptions="
    ...
    --jobName=${jobName}
    --stagingLocation=gs://${projectId}.appspot.com/dataflow-test/staging
    --tempLocation=gs://${projectId}.appspot.com/dataflow-test/temp
    ${args}
    "
}
...
deployTemplate() {
  ...
  ${workspace}/gradlew runJob -PjobClass="${jobClass}" -Poptions="
    --project=${projectId}
    --runner=DataflowRunner
    --templateLocation=gs://${projectId}.appspot.com/dataflow/template/${jobClass}
    --stagingLocation=gs://${projectId}.appspot.com/dataflow/staging
    --tempLocation=gs://${projectId}.appspot.com/dataflow/temp
    "
}
...
runTemplate() {
  ...
  ${workspace}/gradlew runJob -PjobClass="${jobClass}" -Poptions="
    --project=${projectId}
    --jobName=${jobName}
    --templateLocation=gs://${projectId}.appspot.com/dataflow/template/${templateName}
    --stagingLocation=gs://${projectId}.appspot.com/dataflow/staging
    --tempLocation=gs://${projectId}.appspot.com/dataflow/temp
    "
}
